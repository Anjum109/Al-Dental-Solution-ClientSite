        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <Link className="link link-hover">Aesthetic Restoration</Link>
                    <Link className="link link-hover">Reimplantation of avulsed tooth</Link>
                    <Link className="link link-hover">Surgical Extraction</Link>
                </div>
                <div>

                    <Link className="link link-hover">Root Canel </Link>
                    <Link className="link link-hover">Bridges</Link>
                    <Link className="link link-hover">Dentures</Link>
                    <Link className="link link-hover">Amalgam Filling</Link>
                    <Link className="link link-hover">Orthodontics</Link>
                </div>
